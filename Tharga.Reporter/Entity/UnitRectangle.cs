...
public class UnitRectangle : IEquatable<UnitRectangle>
{
    ...
    internal double GetLeft(double totalWidth)
    {
        if (_left != null)
        {
            return _left.Value.GetXUnitValue(totalWidth);
        }

        if (_right != null && _width != null)
        {
            return totalWidth - _width.Value.GetXUnitValue(totalWidth) - _right.Value.GetXUnitValue(totalWidth);
        }
    ...
    internal double GetTop(double totalHeight)
    {
        if (_top != null)
        {
            return _top.Value.GetXUnitValue(totalHeight);
        }
    ...
    internal double GetRight(double totalWidth)
    {
        if (_right != null)
        {
            return _right.Value.GetXUnitValue(totalWidth);
        }

        if (_left != null && _width != null)
        {
            return totalWidth - (_left.Value.GetXUnitValue(totalWidth) + _width.Value.GetXUnitValue(totalWidth));
        }
    ...
    internal double GetBottom(double totalHeight)
    {
        if (_bottom != null)
        {
            return _bottom.Value.GetXUnitValue(totalHeight);
        }

        if (_top != null && _height != null)
        {
            return totalHeight - (_top.Value.GetXUnitValue(totalHeight) + _height.Value.GetXUnitValue(totalHeight));
        }
    ...
    internal double GetWidht(double totalWidth)
    {
        if (_width != null)
        {
            return _width.Value.GetXUnitValue(totalWidth);
        }

        if (_left != null && _right != null) //Left and right has been set
        {
            return totalWidth - _left.Value.GetXUnitValue(totalWidth) - _right.Value.GetXUnitValue(totalWidth);
        }

        if (_left != null) //Only left has been set
        {
            return totalWidth - _left.Value.GetXUnitValue(totalWidth);
        }

        if (_right != null) //Only right has been set
        {
            return totalWidth - _right.Value.GetXUnitValue(totalWidth);
        }
    ...
    internal double GetHeight(double totalHeight)
    {
        if (_height != null)
        {
            return _height.Value.GetXUnitValue(totalHeight);
        }

        if (_top != null && _bottom != null)
        {
            return totalHeight - _top.Value.GetXUnitValue(totalHeight) - _bottom.Value.GetXUnitValue(totalHeight);
        }

        if (_top != null)
        {
            return totalHeight - _top.Value.GetXUnitValue(totalHeight);
        }

        if (_bottom != null)
        {
            return totalHeight - _bottom.Value.GetXUnitValue(totalHeight);
        }
    ...
    internal static UnitRectangle Load(XmlElement xme)
    {
        ...
        if (left != null)
        {
            rect.Left = UnitValue.Parse(left.Value);
        }

        var top = xme.Attributes["Top"];
        if (top != null)
        {
            rect.Top = UnitValue.Parse(top.Value);
        }

        var right = xme.Attributes["Right"];
        if (right != null)
        {
            rect.Right = UnitValue.Parse(right.Value);
        }

        var bottom = xme.Attributes["Bottom"];
        if (bottom != null)
        {
            rect.Bottom = UnitValue.Parse(bottom.Value);
        }

        var width = xme.Attributes["Width"];
        if (width != null)
        {
            rect.Width = UnitValue.Parse(width.Value);
        }

        var height = xme.Attributes["Height"];
        if (height != null)
        {
            rect.Height = UnitValue.Parse(height.Value);
        }
